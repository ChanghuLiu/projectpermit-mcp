...
class SchemaContractTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.samples = [
            ...
            {"jurisdiction": "gatineau_qc", "project": {"family": "interior_renovation", "estimated_cost_cad": 10000, "structural_change": False}},
    ...
    def test_unresolved_overlay_fields_are_machine_readable(self):
        ...
        self.assertEqual("UNRESOLVED_FOR_EXEMPTION", result["property_context_status"])
