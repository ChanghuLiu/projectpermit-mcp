...
def extract_jobber_work_object(payload: Mapping[str, Any], *, object_type: str | None = None) -> dict[str, Any]:
...
def build_preflight_facts(
    ...
    *,
    ...
    """Build ProjectPermit facts and optionally carry a prior public identity for comparison."""
